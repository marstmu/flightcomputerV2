...
def initialize_log_file(data_dir):
    ...
    with open(log_file, "w") as f:
        f.write("elapsed_time,temperature,pressure,accel_x,accel_y,accel_z,gyro_x,gyro_y,gyro_z\n")
    return log_file

def log_sensor_data(log_file, elapsed_time, temperature, pressure, accel, gyro):
    with open(log_file, "a") as f:
        f.write(f"{elapsed_time:.3f},{temperature},{pressure},{accel[0]},{accel[1]},{accel[2]},{gyro[0]},{gyro[1]},{gyro[2]}\n")
    ...
    try:
        ...
        while True:
            try:
                ...
                gyro = read_gyro_data()
                temperature = (read_temp() / 128) + 25  # Convert IMU temperature
                _, pressure = lps.get()
                ...
                # Log data to CSV
                log_sensor_data(log_file, elapsed_time, temperature, pressure, accel, gyro)
